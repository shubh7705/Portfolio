      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <div className="space-y-6 lg:col-span-7">
          <p className="text-slate-300 leading-relaxed">
            I am a Computer Science undergraduate at <strong className="text-slate-100 font-semibold">IIIT Nagpur</strong> with a strong focus on Generative AI, Multi-LLM Orchestration, and High-Performance Backend Engineering.
          </p>
          ...
          {/* Education Card */}
          <div className="card rounded-xl border-slate-800 bg-surface/90 p-5 mt-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <span className="text-xs font-mono text-accent">Education</span>
            ...
            <div className="mt-5 border-t border-slate-800/80 pt-4">
              <p className="text-xs font-mono text-slate-400 mb-2 font-semibold">
                Relevant Coursework:
              </p>
              <div className="flex flex-wrap gap-1.5">
                {coursework.map((course) => (
                  <span
                    key={course}
                    className="rounded bg-base/80 px-2.5 py-1 text-[11px] font-mono text-slate-300 border border-slate-700/60"
                  >
                    {course}
                  </span>
                ))}
        ...
        <div className="space-y-4 lg:col-span-5">
          <h3 className="font-mono text-sm text-slate-400 font-semibold mb-2">
            🏆 Leadership &amp; Achievements
          </h3>
          ...
          {achievements.map((ach) => (
            <div
              key={ach.title}
              className="card rounded-xl border-slate-800 bg-surface/80 p-4 space-y-2 hover:border-accent/40 transition-colors"
            >
              <div className="flex items-center justify-between gap-2">
                <h4 className="text-sm font-semibold text-slate-200">
                  {ach.title}
                </h4>
                <span className="shrink-0 rounded bg-emerald-500/10 px-2 py-0.5 font-mono text-[10px] font-medium text-emerald-400 border border-emerald-500/20">
                  {ach.badge}
                </span>
              </div>
          ...
          <div className="rounded-xl border border-accent/30 bg-accent/5 p-4 text-xs text-slate-300 font-mono flex items-center justify-between gap-4 mt-4">
            <div>
              <p className="text-accent font-semibold">Looking for opportunities</p>
              <p className="text-[11px] text-slate-400 mt-0.5">Open to AI/ML &amp; Backend internships</p>
            </div>
